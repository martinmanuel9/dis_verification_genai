...
Get DIS Verification GenAI running in 10 minutes!

## Step 1: Download Installer

Visit the [Releases page](https://github.com/martinmanuel9/dis_verification_genai/releases) and download the installer for your operating system:

| Operating System | File to Download |
|-----------------|------------------|
| **Windows 10/11** | `dis-verification-genai-{version}.msi` |
...
## Step 3: Install DIS Verification GenAI
...
### macOS
1. Open the `.dmg` file
2. Drag "DIS Verification GenAI" to Applications
3. Eject the disk image

## Step 4: Configure

### Windows
1. Navigate to: `C:\Program Files\DIS Verification GenAI`
...
### Windows
- Use the Start Menu shortcut: "DIS Verification GenAI"
...
### macOS
- Double-click "DIS Verification GenAI" in Applications
- Or from Terminal:
  ```bash
  cd "/Applications/DIS Verification GenAI.app/Contents/Resources"
  docker compose up -d
...
**Windows:**
```cmd
type "C:\Program Files\DIS Verification GenAI\VERSION"
```
...
**Congratulations!** You're ready to use DIS Verification GenAI! 🚀
