# Release Process for DIS Verification GenAI

## Quick Reference

**Repository:** https://github.com/martinmanuel9/dis_verification_genai
**Releases:** https://github.com/martinmanuel9/dis_verification_genai/releases
...
1. Go to https://github.com/martinmanuel9/dis_verification_genai/actions
2. Watch the "Build Installers" workflow
3. Wait for all jobs to complete (~10-15 minutes)

### Step 4: Verify Release

1. Go to https://github.com/martinmanuel9/dis_verification_genai/releases
2. Verify the new release is created with all assets:
   - ✅ `dis-verification-genai-1.0.1.msi` (Windows)
   - ✅ `dis-verification-genai_1.0.1_amd64.deb` (Debian/Ubuntu)
   - ✅ `dis-verification-genai-1.0.1.x86_64.rpm` (RHEL/CentOS/Fedora)
   - ✅ `dis-verification-genai-1.0.1.dmg` (macOS)
...
**Release Page:**
https://github.com/martinmanuel9/dis_verification_genai/releases

**Quick Start Guide:**
https://github.com/martinmanuel9/dis_verification_genai/blob/main/QUICKSTART.md

**Installation Guide:**
https://github.com/martinmanuel9/dis_verification_genai/blob/main/INSTALL.md
...
Download: https://github.com/martinmanuel9/dis_verification_genai/releases
...
- Open an issue: https://github.com/martinmanuel9/dis_verification_genai/issues
