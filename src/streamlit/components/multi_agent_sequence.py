...
def multi_agent_sequence_debate(agents, agent_choices, collections):
    """
    Multi-Agent Sequence Debate Component
        ...
        if not debate_content:
            ...
            if not sequence_agent_ids:
                ...
                if collection_for_debate:
                    ...
                    debate_type = "RAG-Enhanced Sequence"
                else:
                    ...
                    endpoint = f"{FASTAPI_API}/compliance-check"  # Use compliance check for non-RAG
                ...
                with st.spinner(f"{len(sequence_agent_ids)} agents debating in sequence..."):
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                                ...
                                try:
                                    with st.spinner("Generating Word document..."):
                                        ...
                                        if export_response.status_code == 200:
                                            ...
                                            filename = response_data.get("filename", "debate_simulation_export.docx")
                            ...
                            st.error(f"Sequence debate failed ({response.status_code}): {error_detail}")
